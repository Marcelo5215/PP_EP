...
\section{Resultados experimentais}
	...
	Foram utilizadas dois conjuntos de vetores nos testes, disponibilizados por \cite{pqnns:1}. Ambos contém vetores obtidos pelo algoritmo SIFT.
	
	O conjunto denominado por \textit{siftsmall} contém uma base de dados menor e é consultado menos vezes que a base \textit{sift} (tabela 1).
