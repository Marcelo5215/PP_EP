...
\section{Resultados}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[scale=0.4]{smallTempoProcess}
		\label{smallTempoProcess}
		\caption{Impacto da variação do número de processos no tempo da busca na base siftsmall}
	\end{figure}
	
	\begin{figure}[h]
		\centering
		\includegraphics[scale=0.4]{tempoProcess}
		\label{tempoProcess}
		\caption{Impacto da variação do número de processos no tempo da busca na base sift}
	\end{figure}

	\begin{figure}[h]
		\centering
		\includegraphics[scale=0.4]{tempos}
		\label{tempos}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[scale=0.4]{precision}
		\label{precision}
